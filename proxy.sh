...
# acl allowed_ip src 191.165.220.15 177.27.0.0/16 177.25.0.0/16 177.26.0.0/16 189.40.0.0/16 177.50.0.0/16 187.48.0.0/16
...
#Substitua pelo seu hostname
logfile_rotate 5

# Evitar vazamento de cabeçalhos (ofuscação de dados)
...
# Portas seguras (adicionar mais portas se necessário)
